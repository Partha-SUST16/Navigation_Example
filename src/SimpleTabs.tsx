...
interface MyPeopeScreenProps{
    navigation: NavigationScreenProp<NavigationState>;
}

class MyPeopleScreen extends React.Component<MyPeopeScreenProps>{
  componentDidMount() {
    console.log("MyPeopleScreen mounted");
  }
  componentWillUnmount(){
    console.log("MyPeopleScreen unmounted");
  }
...
class MySettingsScreen extends React.Component<MyChatScreenProps>{
  componentDidMount() {
    console.log("MySettings mounted");
  }
  componentWillUnmount(){
    console.log("MySettings unmounted");
  }
  render() {
    const { navigation } = this.props;
    return <MyNavScreen banner="Settings Tab" navigation={navigation} />;
  }
...
class SimpleTabsContainer extends React.Component<SimpleTabsContainerProps>{
  ...
  componentDidMount() {
    console.log("SimpleTab Container Mounted");
  }
  componentWillUnmount(){
    console.log("SimpleTabs Container unmounted");
  }
  render() {
    {console.log("SimpleTabsContainer Rendering");}
